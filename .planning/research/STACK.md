...
**Domain:** LNBits extension for Lightning Network gift cards
...
uv pip install -e /home/exedev/lnbits

# Dev dependencies (match the events extension reference):
uv pip install black ruff mypy pre-commit pytest pytest-asyncio
```
...
**If the issuer creates a single gift card:**
...
**If the issuer distributes cards via email:**
...
**If bulk CSV import is required:**
...
**If native wallet QR redemption is required later:**
...
---
*Stack research for: LNBits Gift Cards extension*
*Researched: 2026-06-29*
